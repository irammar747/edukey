...
```env
DATABASE_URL="mysql://edukey_user:edukey_password@db:3306/edukey_db?serverVersion=8.0&charset=utf8mb4"
```
...
| **Docente** | `docente1`      | `docente1123` |

## 6. Resolución de Problemas Comunes

### 6.1. Conflicto de Puertos
Si los puertos **8082** o **3326** ya están ocupados por otros servicios en su máquina host, modifique el mapeo en el archivo `docker-compose.yml`.
